...
// canva
export let canvasWireBwModsigToIntegrator = document.getElementById(
	"canvasWireBwModsigToIntegrator"
);
export let canvasWireBwModsigToMultiplier = document.getElementById(
	"canvasWireBwModsigToMultiplier"
);
export let canvasWireBwCarsigToModulator = document.getElementById("canvasWireBwCarsigToModulator");
export let canvasWireBwIntegratorToMultiplier = document.getElementById(
	"canvasWireBwIntegratorToMultiplier"
);
export let canvasWireBwMultiplierToModulator = document.getElementById(
	"canvasWireBwMultiplierToModulator"
);
export let canvasWireBwModulatorToDifferentiator = document.getElementById(
	"canvasWireBwModulatorToDifferentiator"
);
export let canvasWireBwDifferentiatorTodcLimiter = document.getElementById(
	"canvasWireBwDifferentiatorTodcLimiter"
);
export let canvasWireBwenvelopeDetToParamExtract = document.getElementById(
	"canvasWireBwenvelopeDetToParamExtract"
);
export let canvasWireBwdcLimiterToEnvelopeDetector = document.getElementById(
